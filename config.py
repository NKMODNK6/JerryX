...
OWNER_ID = int(getenv("OWNER_ID", 7892358978))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Devokop/Devxd",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MEETIIKALHER_UPDATE")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/MEETIIKALHER_UPDATE")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/NLM.jpg"
)
PING_IMG_URL = getenv(
