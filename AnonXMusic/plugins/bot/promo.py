...
@app.on_message(filters.command("promo") & filters.user(OWNER_ID))
@language
async def broadcast_message(client, message, _):
    ...
    if message.reply_to_message:
        ...
        if len(message.command) < 2:
            return await message.reply_text(_["promo_1"])
    ...
    if "-nobot" not in message.text:
        ...
        for i in chats:
            try:
                ...
                continue
        try:
            await message.reply_text(_["promo_2"].format(sent, pin))
        except:
            pass
    ...
    if "-user" in message.text:
        ...
        for i in served_users:
            try:
                ...
                continue
        try:
            await message.reply_text(_["promo_3"].format(susr))
        except:
            pass
    IS_BROADCASTING = False
